...
//I have this commented out because it gets kinda laggy xd.
...
public class TestJumpEvent {
	...
	public static void testJumpEvent(LivingJumpEvent event) {
		...
		//world.setBlockState(livingEntity.getPosition().add(0, 5, 0), BlockInit.RUBY_BLOCK.get().getDefaultState());
